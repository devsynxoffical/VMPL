  ...
  items: [
    {
      ...
      metric: "$1,500/month × 3-month retainer",
      src: "/testimonials/portrait-2.mp4",
      width: 720,
      height: 1280,
      label: "Edgar - Agency Owner",
    },
    {
      id: "marie-grace-berg",
      ...
      width: 1280,
      height: 720,
      label: "Marie Grace Berg - High-Ticket Coach",
    },
    {
      id: "muhammad-ghattas",
      ...
      width: 1280,
      height: 720,
      label: "Muhammad Ghattas - Roofing Marketing Agency",
    },
    {
      id: "giulia",
      name: "Giulia",
      ...
      width: 1280,
      height: 720,
      label: "Giulia - MVA Marketing Agency Founder",
    },
    {
      id: "edgar-jeremi",
      name: "Edgar & Jeremi",
      ...
      headline:
        "Winning High-Ticket Clients While Generating Incredible Results for Their Clients Too",
      src: "/testimonials/square-1.mp4",
      width: 720,
      height: 720,
      label: "Edgar & Jeremi - Co-Founders",
    },
    {
      id: "mohanded",
      name: "Mohanded",
      ...
      width: 720,
      height: 1280,
      label: "Mohanded - Social Media Marketing Agency Germany",
    },
  ],
} as const;
...
export const featuredClients = [
  {
    ...
    meta: "19K Followers",
    image: "/clients/client-darrell-stern.webp",
  },
  {
    name: "Pierce Grimes",
  ...
  },
  {
    ...
    meta: "1.5M Followers",
    image: "/clients/client-officer-baker.webp",
  },
  {
  ...
  },
  {
    ...
    role: "Pediatrician",
    meta: "144k Followers",
    image: "/clients/client-dr-bea-kinderaerztin.webp",
  },
  {
    name: "Steven Juergensen",
    role: "Founder @ Vedgenutrition",
    meta: "87k Followers",
    image: "/clients/client-steven-juergensen.webp",
  },
  {
    name: "Rafael Cintron",
    role: "E-commerce Coach",
    meta: "55.7K Subscribers",
    image: "/clients/client-rafael-cintron.webp",
  },
  {
  ...
  },
  {
    ...
    meta: "21k Followers",
    image: "/clients/client-jared-van-yperen.webp",
  },
  {
    name: "M Mahdi Syed",
    role: "Business Scaling Coach",
    meta: "Two Comma Club Winner",
    image: "/clients/client-m-mahdi-syed.webp",
  },
  {
    name: "Aref Jomah",
    role: "7 Figure Agency Scaling Coach",
    meta: "Two Comma Club Winner",
    image: "/clients/client-aref-jomah.webp",
  },
  {
  ...
  },
  {
    ...
    role: "Agency Owner",
    meta: "7K Followers",
    image: "/clients/client-marie-grace-berg.webp",
  },
] as const;
